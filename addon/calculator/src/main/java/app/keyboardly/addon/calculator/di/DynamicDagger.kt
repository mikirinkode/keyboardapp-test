package app.keyboardly.addon.calculator.di

import app.keyboardly.addon.calculator.CalculatorDefaultClass
import app.keyboardly.addon.calculator.DynamicFeatureImpl
...
class DynamicModule {
     ...
     */
    @Provides
    internal fun provideDefaultClass(dependency: KeyboardActionDependency) = CalculatorDefaultClass(dependency)
